...
const staticConfig: AssetsConfig = {
  ...
  */
  ...
  |--------------------------------------------------------------------------
  |
  | Decide how you want the static public server to handle the `dotfiles`.
  ...
  */
  ...
  | if you fingerprint your public.
  |
  ...
  */
  ...
  |--------------------------------------------------------------------------
  |
  | Set the immutable directive. Set it to `true` if the public are generated
